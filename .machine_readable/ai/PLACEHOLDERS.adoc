...
sed -i 's/game-server-admin/my-project/g' $(grep -rl 'game-server-admin' .)
sed -i 's/GameServerAdmin/MY_PROJECT/g' $(grep -rl 'GameServerAdmin' .)
sed -i 's/game-server-admin/my_project/g' $(grep -rl 'game-server-admin' .)
sed -i 's/game-server-admin/my-project/g' $(grep -rl 'game-server-admin' .)
sed -i 's/github/github.com/g' $(grep -rl 'github' .)
...
| `github` | Git forge domain | `github.com` | CONTRIBUTING.md |
...
| `2026-03-22` | Last updated date | `2026-02-14` | TOPOLOGY.md, THREAT-MODEL.md |
...
| `https://github.com/hyperpolymath/game-server-admin` | Project website | `https://example.org` | SECURITY.md |
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `AGPL-3.0-or-later` | License name | `AGPL-3.0-or-later` | ABI-FFI-README.md |
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `game-server-admin` | Repository name | `my-project` | 0-AI-MANIFEST.a2ml |
| `2026-03-22` | Creation date | `2026-02-14` | 0-AI-MANIFEST.a2ml |
